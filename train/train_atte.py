...
from model.atte_model import Delf_res50_atte
from dataloader import get_atte_dataloader
...
def train(cfg):
    ...
    train_loader, val_loader = get_atte_dataloader(train_folder_root=cfg.train_data_root, 
    ...
    # model config
    model = Delf_res50_atte(num_classes=cfg.ncls, ft_state_dict_path=cfg.ft_ckpt)
    model.load_state_dict(torch.load("/home/workspace/chencheng/Learning/ImageRetrieval/delf-pytorch/repository/attention/epoch_14_loss_2.38009.pth"))
    ...
    top5_sum = 0
    model.train()
    for epoch in range(13, cfg.ft_epochs):
        epoch_loss = []
        for iter, (inputs, labels) in enumerate(train_loader):
            ...
            if (iter+1) % print_interval == 0:
                ...
                message = '[{}] epoch: {}/{}, iters: {}/{}, top-1: {:.4f}, top-3: {:.4f}, top-5: {:.4f}, loss: {:.4f}.'\
                        .format(cfg.stage, epoch+1, cfg.ft_epochs, iter+1, train_iters_all, top1_avg, top3_avg, top5_avg, loss.item())
